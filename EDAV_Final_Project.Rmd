...
* Akshata Patel: Akshata worked on the exploratory data analysis of the dataset.
* Kiran Saini: Kiran worked on creating the interactive component of the project using D3.
* Ujjwal Peshin: Ujjwal worked on the exploratory data analysis of the dataset.
...
* The datasets are limited to certain regions and are have not been expanded to further regions. Having data on more regions might allow us to look at more intra-migration incidents and more trafficking events.
